...
from quicksviewer.data.dataset import DataCollatorForSupervisedDataset, DataCollatorForSupervisedDatasetSeqParallel
from quicksviewer.train.sequence_parallel import set_pg_manager
from quicksviewer.model.utils import set_seqlens_in_batch, patch


class LlavaConfig(Qwen2Config):
    model_type = "quicksviewer_qwen"
...
if LlavaConfig.model_type == "quicksviewer":
    LlavaConfig.model_type = "quicksviewer_qwen"

AutoConfig.register("quicksviewer_qwen", LlavaConfig)
AutoModelForCausalLM.register(LlavaConfig, LlavaQwenForCausalLM)
